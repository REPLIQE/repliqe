...
export const TYPE_OVERLINE = 'text-[11px] font-bold uppercase tracking-wider text-muted'

/** Overline med stærkere kontrast */
export const TYPE_OVERLINE_STRONG = 'text-[11px] font-bold uppercase tracking-wider text-muted-strong'

/** Meget fin brød / diagram-fod */
export const TYPE_CAPTION = 'text-[10px] text-muted'

/** Label under store tal (stat tiles, workout summary grid) */
export const TYPE_LABEL_UPPER = 'text-[10px] font-bold text-muted uppercase tracking-[0.5px]'

/** Sekundær linje under titel */
...
/** Ekstra stort tal (fx recovery overall %) */
export const TYPE_DISPLAY_LG = 'text-[27px] font-extrabold'
...
/** Tabellignende meta, dato-kolonner */
...
/** Ekstra lille label (recovery grid, foto) */
export const TYPE_MICRO_TIGHT = 'text-[9px] text-muted'

export const TYPE_RING_PCT = 'text-[10px] font-extrabold text-white'

/** Ekstra lille overskrift (recovery-grid muskelnavne) */
export const TYPE_LABEL_MICRO = 'text-[9px] font-bold text-muted uppercase tracking-[0.4px] text-center'

/** Formularfelt-labels (semibold) */
...
/** Segment / faner (Start | Plan, vinkler) */
export const TYPE_TAB = 'text-[12px] font-bold'

/** “IN PROGRESS” m.m. på start-kort */
export const TYPE_STATUS_BADGE = 'text-[11px] font-extrabold tracking-[0.8px]'

/** Stort “+” på programme tiles */
export const TYPE_HERO_PLUS = 'text-[23px] font-light'
